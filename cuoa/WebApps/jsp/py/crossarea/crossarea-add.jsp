    	...
    	//提交
         function f_submit(){
        	...
        	if($("form.validate").valid()){
	        	...
	        	$.post(contextPath + "/py-crossarea/crossarea!add.action", param, function(json){
					if(json.success){
	     ...
	     function verify()
	     {
			...
			if(remark==""||reg.test(remark)){  alert("请填写备注！","warn");	return false;}  
			if(remark.length>200)  {  alert("备注应在200字符以内!","warn");	return false;}  
			
			var reasonForCross =  $("#reasonForCross").val();
			if(reasonForCross==""||reg.test(reasonForCross)){  alert("请填写跨点原因！","warn");	return false;}  
			if(reasonForCross.length>200)  {  alert("跨点原因应在200字符以内!","warn");	return false;}  
...
<body>
 <form class="l-form validate">
    <div class="content">
    	<ul>
    		<li>
    			<input type="hidden" name="crossArea.courseId" id="courseId">
    			<input type="hidden" name="crossArea.verifyYearMonth" id="verifyYearMonth">
    			<input type="hidden" name="crossArea.summaryCurrId" id="summaryCurrId">
    	...
    	<ul>	
			...
			<li>
				<label>记录人：</label>
    			<input type="text"  name="crossArea.recorderName" id="recorderName"  class="required input-text"  />
			</li>
    	</ul>	
    	<ul>
    		<li>
    	...
    	<ul>
    		<li>
    			<textarea name="crossArea.remark" id="remark" rows="11" cols="100"></textarea>		
    		</li>
    	</ul>     		
    	<ul>
    		<li>
    	...
    	<ul>
    		<li>
    			<textarea name="crossArea.reasonForCross" id ="reasonForCross" rows="11" cols="100"></textarea>		
    		</li>
    	</ul>    	   	
    </div>
    </form>
