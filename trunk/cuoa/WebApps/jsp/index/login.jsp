...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head> 
    ...
    <link href="<%=path%>/ligerui/ligerUI/skins/Aqua/css/ligerui-dialog.css" rel="stylesheet" type="text/css" />
    <link href="<%=path%>/ligerui/ligerUI/skins/Gray/css/dialog.css" rel="stylesheet" type="text/css" />
    <script src="<%=path%>/ligerui/ligerUI/js/core/base.js" type="text/javascript"></script>
    <script src="<%=path%>/ligerui/ligerUI/js/plugins/ligerDialog.js" type="text/javascript"></script>
    <style type="text/css">
        *{ padding:0; margin:0;}
        ...
        .login-btn{width:114px; height:29px; color:#E9FFFF; line-height:29px; background:url('images/login/login-btn.gif') no-repeat; border:none; overflow:hidden; cursor:pointer;}
    ...
    <script type="text/javascript">
		...
		function refreshCheckCode() {
			$("#random").attr("src","<%=basePath%>checkcode/random.jsp?random="+Math.random());
		}
        ...
        $(function ()
        {
            ...
            function dologin()
            {
                ...
                var urlstr = '<%=basePath%>login!login.action';
                ...
                $.ajax({
                    ...
                    {
	                    if (json.success) {
	 						location.href = "<%=basePath%>login!index.action";
						}else
						{
							    alert(json.message);
							    refreshCheckCode();
                    ...
                    <table cellpadding="0" cellspacing="0">
                        <tbody>
                         <tr>
                            ...
                            <tr>
                            <td align="right">账&nbsp;&nbsp;&nbsp;&nbsp;号：</td><td align="left"><input type="text" name="condition.loginName" id="txtUsername"  class="login-text" /></td>
                            </tr>
                            <tr>
                            <td align="right">密&nbsp;&nbsp;&nbsp;&nbsp;码：</td><td align="left"><input type="password" name="condition.loginPwd" id="txtPassword"  class="login-text" /></td>
                            </tr> 
                            <tr>
                            	<td align="right">验证码：</td>
                            	<td align="left"> 
                            		<input name="condition.verifyCode" id="checkyzm" type="text" class="login-text" />
                            		<a href="javascript:refreshCheckCode();"><img src="<%=basePath%>checkcode/random.jsp" alt="看不清，换一张" name="random" border="0" align="absmiddle" id="random" valign="absmiddle" /></a>
                            	</td>
                            </tr> 
                            <tr>
