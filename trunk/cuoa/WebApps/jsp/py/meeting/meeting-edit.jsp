...
<script src="<%=contextPath %>/js/class.js" type="text/javascript"></script>
 <script type="text/javascript">
	   ...
	   $(document).ready(function(){
	   		...
	   		$("#remark").val("<s:property value='meeting.remark'/>");
	   		$("#teacherId").val("<s:property value='meeting.teacherId'/>");
			$("#meetingId").val("<s:property value='meeting.id'/>");

			var verifyYearMonth = "<s:property value='meeting.verifyYearMonth'/>";
			if (verifyYearMonth.length == 7) {
				$("#verify_year").val(verifyYearMonth.split("-")[0]);
				$("#verify_month").val(verifyYearMonth.split("-")[1]);
			}
			
			load_basic("<s:property value='meetingBasic.year'/>","<s:property value='meetingBasic.termId'/>","<s:property value='meetingBasic.gtId'/>","<s:property value='meetingBasic.gradeId'/>","<s:property value='meetingBasic.subjectId'/>","");
    	...
    	//提交
         function f_submit(){
        	...
        	if($("form.validate").valid()){
	        	...
	        	$.post(contextPath + "/py-meeting/meeting!edit.action", param, function(json){
					if(json.success){
...
<body>
 <form class="l-form validate">
    	...
    	<ul>
    		<li>
    			<input type="hidden" name="meeting.id" id ="meetingId">
    	...
    	<ul>
    		<li>
    			<label>会议名称：</label>
    			<input type="text"  name="meeting.meetingName" id="meetingName"  class="required input-text"  value="<s:property value='meeting.meetingName'/>" />
    		</li>
    		<li>
    			<label>教师姓名：</label>
    			<input type="text"  id="teacherName"  class="required input-text"  readonly="readonly" value="<s:property value='meeting.teacherName'/>"/>
    		</li>
    		<li>
    	...
    	<ul>
    		<li>
    			...
    			<input id="startDate" name="meeting.startDate" type="text" class="Wdate input-text"  value="<fmt:formatDate value='${meeting.startDate}' pattern='yyyy-MM-dd'/>"
    		...
    		<li>
    			...
    			<input id="reviewVideoDeadline" name="meeting.reviewVideoDeadline" type="text" class="input-text"  value="<fmt:formatDate value='${meeting.reviewVideoDeadline}' pattern='yyyy-MM-dd'/>"/>
    	...
    	<ul>
    		<li>
    			<textarea rows="11" cols="100" readonly="readonly"><s:property value='meeting.reasonForAbsence'/></textarea>		
    		</li>
    	</ul>    	
    	<ul>
    		<li>
    	...
    	<ul>
    		<li>
    			<textarea  rows="11" cols="100" readonly="readonly"><s:property value='meeting.reasonForNoReview'/></textarea>		
    		</li>
    	</ul>    	
    	<ul>
    		<li>
    	...
    	<ul>
    		<li>
    			<textarea name="meeting.reasonForModify" rows="11" cols="100" id="reasonForModify"><s:property value='meeting.reasonForModify'/></textarea>		
    		</li>
    	</ul>       		
    </div>
    </form>
