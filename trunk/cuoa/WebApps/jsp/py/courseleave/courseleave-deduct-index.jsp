...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		var leaveId = "<s:property value='condition.ids'/>";
         ...
         function f_submit(){
			...
			var message = "";
         	if(check == "1")
         	{
         		url = url + "/py-courseleave/courseleave!auditDelete.action"
         		label = "废除操作";
				message = "确认废除吗？";
         	}
         	else if(check == "0")
         	{
         		url = url + "/py-courseleave/courseleave!unlock.action"
         		label = "解锁操作";
				message = "确认解锁吗？";
         	}	
         	else
	...
	$(function() {
		var g = {
			gridid : "maingrid",
			conditon : "condition",
			url : contextPath + "/py-courseleave/courseleave!dataForDeduct.action",
