...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	$(function() {
		var g = {
			gridid : "maingrid",
			conditon : "condition",
			url : contextPath + "/py-confirmlesson/confirmlesson!data.action",
			...
			<div class="content">
				...
				<ul>
					...
					<li>
						...
						<input id="specific_startDate_start" name="condition.specificDateStart" type="text"
							class="input-text" />
						<img onclick="WdatePicker({el:'specific_startDate_start'})"
							src="<%=contextPath%>/js/my97/skin/datePicker.gif" width="16"
							height="22" align="absmiddle">
					</li>
					<li>
						...
						<input id="specific_startDate_end" name="condition.specificDateEnd" type="text" class="input-text" />
						<img onclick="WdatePicker({el:'specific_startDate_end'})"
							src="<%=contextPath%>/js/my97/skin/datePicker.gif" width="16"
							height="22" align="absmiddle">
					</li>
					<li>
