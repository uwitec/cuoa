...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	$(function() {
		var g = {
			gridid : "maingrid",
			conditon : "condition",
			url : contextPath + "/py-courselate/courselate!queryLateLog.action?role=${role}",
	...
	<body>
			<form id="conditionForm">
				<input  type="hidden" name="lateLogCondition.lateId" value="<s:property value='lateLogCondition.lateId'/>" />
			</form>
