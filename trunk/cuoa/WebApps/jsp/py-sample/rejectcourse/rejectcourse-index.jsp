...
<script src="<%=contextPath %>/js/jsp/py/rejectcourse.js" type="text/javascript"></script>		
<script type="text/javascript">
	...
	function excel(item) {
	    exportData("/py-rejectcourse/rejectcourse!export.action", [0,1], "${role}");
	}
</script>
	</head>
	<body>
				...
				<ul>
					<li>
						...
						<s:if test="role==1">
							...
							<input type="button" id="exportButton" value="特殊导入" class="l-button" onclick="f_special_import()"/>
							<input type="button" id="termButton" value="甩班学期归属" class="l-button" onclick="f_batch_term()"/>
