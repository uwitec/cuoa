...
(function ($)
{
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        {
            var g = this, p = this.options;
            removeDivContent("export_other_param_div");
            putValueInHidden("pageSizeE","condition.pageSizeE", p.pageSize);
            putValueInHidden("pageNumE","condition.pageNumE", p.page);
            g.loading = true;
            var clause = null;
            var loadServer = true;
            ...
            if (p.parms)
            {
                ...
                /**sunchuanbao modify 2012/7/26 支持function 返回数组参数 */
